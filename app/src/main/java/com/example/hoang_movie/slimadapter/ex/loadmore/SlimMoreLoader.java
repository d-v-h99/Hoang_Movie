package com.example.hoang_movie.slimadapter.ex.loadmore;
...
import com.example.hoang_movie.slimadapter.CustomLinearLayoutManager;
    ...
    public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
        ...
        switch (newState) {
            case RecyclerView.SCROLL_STATE_IDLE:
                int last = ((CustomLinearLayoutManager) recyclerView.getLayoutManager()).findLastCompletelyVisibleItemPosition();
                if (NO_POSITION == last) {
                    break;
                }
